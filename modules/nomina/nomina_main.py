...
class NominaModule(ctk.CTkFrame):
    ...
    def crear_widgets(self):
        ...
        add_tooltip(titulo, "Administración de empleados y pagos de nómina")
    ...
    def crear_tab_empleados(self):
        ...
        # Inicializar opciones de cargos
    ...
    def cargar_empleados(self):
        ...
        try:
            with db.get_connection() as conn:
                ...
                filtradas = []
                for row in rows:
                    r_estado = row['estado_actual'] if hasattr(row, 'keys') else row[7]
