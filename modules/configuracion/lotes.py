...
class LotesFrame(ctk.CTkFrame):
    ...
    def crear_widgets(self):
        ...
        self.combo_finca = ctk.CTkComboBox(row0, height=35)
        ...
        self.combo_criterio = ctk.CTkComboBox(row3, values=["Por Peso", "Por Edad", "Por Origen", "Por Salud", "Por Producción", "Personalizado"], height=35)
        ...
        self.tabla = ttk.Treeview(table_frame, columns=("id", "finca", "codigo", "nombre", "descripcion", "criterio"), show="headings", 
                                  displaycolumns=("finca", "codigo", "nombre", "descripcion", "criterio"), height=18)
        ...
        ctk.CTkButton(action_frame, text="✏️ Editar Seleccionado", height=40, command=self.editar_lote).pack(side="left", padx=5)
        ...
        ctk.CTkButton(action_frame, text="🔄 Actualizar Lista", height=40, command=self.cargar_lotes).pack(side="left", padx=5)
