...
class CondicionesCorporalesFrame(ctk.CTkFrame):
    ...
    def crear_widgets(self):
        ...
        # Tabla
        self.tabla = ttk.Treeview(table_frame, columns=("codigo", "descripcion", "puntuacion", "escala", "especie"), show="headings", height=18)
        ...
        ctk.CTkButton(action_frame, text="👁️ Ver Detalles", height=40, command=self.ver_detalles).pack(side="left", padx=5)
        ctk.CTkButton(action_frame, text="✏️ Editar Seleccionado", height=40, command=self.editar_condicion).pack(side="left", padx=5)
        ...
        ctk.CTkButton(action_frame, text="🔄 Actualizar Lista", height=40, command=self.cargar_condiciones).pack(side="left", padx=5)
        ...
        try:
            with db.get_connection() as conn:
                ...
                if resultado:
                    ...
                    detalles_window.transient(self.winfo_toplevel())
                    ...
                    # Botón cerrar
                    ctk.CTkButton(frame, text="Cerrar", height=40, command=detalles_window.destroy).pack(pady=10)
