...
class PotrerosFrame(ctk.CTkFrame):
    ...
    def crear_widgets(self):
        ...
        self.combo_finca = ctk.CTkComboBox(row1, width=300, command=self.on_finca_seleccionada, height=35)
        ...
        self.combo_sector = ctk.CTkComboBox(row2, width=140, values=["Sin Sector"], height=35)
        ...
        self.combo_pasto = ctk.CTkComboBox(row4, values=["Brachiaria", "Pangola", "Estrella", "Guinea", "Mixto", "Otro"], height=35)
        ...
        self.combo_estado = ctk.CTkComboBox(row4, values=["Activo", "En Mantenimiento", "Inactivo"], height=35)
        ...
        ctk.CTkButton(action_frame, text="✏️ Editar Seleccionado", height=40, command=self.editar_potrero).pack(side="left", padx=5)
        ...
        ctk.CTkButton(action_frame, text="🔄 Actualizar Lista", height=40, command=self.cargar_potreros).pack(side="left", padx=5)
