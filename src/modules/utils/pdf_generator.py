...
def abrir_manual_pdf():
    ...
    try:
        # Ruta del manual PDF
        pdf_path = Path(__file__).parent.parent.parent / "docs" / "Manual_Usuario_FincaFacil.pdf"
...
def generar_manual_pdf(md_path: str = None, pdf_path: str = None):
    ...
    Args:
        md_path: Ruta del archivo Markdown fuente. Por defecto usa docs/Manual_Usuario_FincaFacil.md
        pdf_path: Ruta destino del PDF. Por defecto usa docs/Manual_Usuario_FincaFacil.pdf

    Returns:
        (exito: bool, mensaje|ruta_pdf)
    """
    # Rutas por defecto
    base_dir = os.path.dirname(os.path.dirname(os.path.dirname(os.path.abspath(__file__))))
    md_path = md_path or os.path.join(base_dir, "docs", "Manual_Usuario_FincaFacil.md")
    pdf_path = pdf_path or os.path.join(base_dir, "docs", "Manual_Usuario_FincaFacil.pdf")
