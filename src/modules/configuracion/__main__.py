...
class ConfiguracionModule(ctk.CTkFrame):
    def __init__(self, master):
        ...
        # Colores del módulo
        self.color_bg, self.color_hover = obtener_colores('configuracion')
        ...
        self.work_area = ctk.CTkScrollableFrame(self.main_container)
    ...
    def crear_menu_lateral(self):
        ...
        # Título del menú con color del módulo
        header = ctk.CTkFrame(menu_frame, fg_color=(self.color_bg, "#1a1a1a"), corner_radius=12)
        header.pack(fill="x", padx=8, pady=(10, 12))
        titulo_menu = ctk.CTkLabel(header, text="📋 Configuraciones", 
                       font=("Segoe UI", 16, "bold"),
                       text_color="white")
        titulo_menu.pack(side="left", padx=12, pady=8)
