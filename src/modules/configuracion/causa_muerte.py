...
class CausaMuerteFrame(ctk.CTkFrame):
    ...
    def guardar_causa(self):
        ...
        try:
            self.configuracion_service.crear_causa_muerte(
                codigo=codigo,
                descripcion=descripcion,
                tipo_causa=self.combo_tipo.get(),
    ...
    def cargar_causas(self):
        ...
        try:
            filas = self.configuracion_service.listar_causas_muerte()
            for fila in filas:
    ...
    def eliminar_causa(self):
        ...
        if messagebox.askyesno("Confirmar", f"¿Eliminar la causa '{codigo}'?"):
            try:
                self.configuracion_service.cambiar_estado_causa_muerte(codigo, "Inactivo")
        ...
        try:
            ...
            for fila in filas:
                registros.append({
                    ...
                    'tipo_causa': str(fila.get('tipo_causa') or 'Enfermedad').strip(),
