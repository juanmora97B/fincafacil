...
class InsumosModule(ctk.CTkFrame):
    def __init__(self, master):
        ...
        # Colores del módulo
        self.color_bg, self.color_hover = obtener_colores('insumos')
    ...
    def crear_widgets(self):
        ...
        titulo = ctk.CTkLabel(header, text="🔧 Gestión de Insumos y Semillas", font=("Segoe UI", 22, "bold"), text_color="white")
