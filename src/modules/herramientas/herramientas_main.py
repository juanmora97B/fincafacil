...
class HerramientasModule(ctk.CTkFrame):
    def __init__(self, master):
        ...
        # Colores del módulo
        self.color_bg, self.color_hover = obtener_colores('herramientas')
    ...
    def crear_widgets(self):
        ...
        header = ctk.CTkFrame(container, fg_color=(self.color_bg, "#1a1a1a"), corner_radius=15)
        header.pack(fill="x", padx=15, pady=(10, 6))
        titulo = ctk.CTkLabel(header, text="🔧 Gestión de Herramientas y Equipos", font=("Segoe UI", 22, "bold"), text_color="white")
